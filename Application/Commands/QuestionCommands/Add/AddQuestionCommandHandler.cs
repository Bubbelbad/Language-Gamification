...
{
    public class AddQuestionCommandHandler(IGenericRepository<Question, int> repository, IMapper mapper) : IRequestHandler<AddQuestionCommand, OperationResult<GetQuestionDto>>
    {
